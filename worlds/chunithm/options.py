...
class RegionVersion(Choice):
    """
    Selects what game region your chunithm is on
...
class DifficultyOption(OptionSet):
    ...
    default = ["Basic", "Advanced", "Expert", "Master", "Ultima"]
    valid_keys = ["Basic", "Advanced", "Expert", "Master", "Ultima"]
...
@dataclass
class ChuniOptions(PerGameCommonOptions):
