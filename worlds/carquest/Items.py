...
item_table: Dict[str, CarQuestItemData] = {
    ...
    "Hub: University Lower Forth Row Ramp":         CarQuestItemData("secret", 53, ItemClassification.progression),
    "Hub: University Lower Back Artifact Platform": CarQuestItemData("secret", 54, ItemClassification.progression),
    "Hub: University Second Floor Ramp":            CarQuestItemData("secret", 55, ItemClassification.progression),
    "Hub: Upper Bridge Jump Walls":                 CarQuestItemData("secret", 56, ItemClassification.progression),
    "Hub: Tree Area Door":                          CarQuestItemData("secret", 57, ItemClassification.progression),
    "Hub: University Portal Buttons":               CarQuestItemData("secret", 58, ItemClassification.progression),
    "Hub: Throne Room Door":                        CarQuestItemData("secret", 59, ItemClassification.progression),
    "Hub: Power Room South Door":                   CarQuestItemData("secret", 60, ItemClassification.progression),
    "Hub: University Portal Planetarium Access":    CarQuestItemData("secret", 61, ItemClassification.progression),
    "Hub: Power Room North Door":                   CarQuestItemData("secret", 62, ItemClassification.progression),
    "Hub: World Peace":                             CarQuestItemData("secret", 63, ItemClassification.progression), # secret name: brickbristles
    ...
    "Throne: Open South Windows":                   CarQuestItemData("secret", throneOffset + 3, ItemClassification.progression),
