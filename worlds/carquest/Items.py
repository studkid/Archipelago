...
item_table: Dict[str, CarQuestItemData] = {
    ...
    "Throne: West South Window":                    CarQuestItemData("secret", throneOffset + 10, ItemClassification.progression),
    "Throne: East South Window":                    CarQuestItemData("secret", throneOffset + 11, ItemClassification.progression),
    ...
    "Throne: Lower High Garden Exit Ledge":         CarQuestItemData("secret", throneOffset + 14, ItemClassification.progression),
    "Throne: North Throne Hidden Door":             CarQuestItemData("secret", throneOffset + 15, ItemClassification.progression),
    "Throne: Throne Ramp":                          CarQuestItemData("secret", throneOffset + 16, ItemClassification.progression),
    "Throne: Exit Portal":                          CarQuestItemData("secret", throneOffset + 17, ItemClassification.filler),
