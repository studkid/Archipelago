...
def create_regions(multiworld: MultiWorld, player: int, options: CarQuestOptions):
    regions: Dict[str, CarQuestRegionData] = {
        ...
        "Hub Pool Area":                     CarQuestRegionData([], ["Hub Upper Uni Alleyway", "Hub South Pool Dead End Path",
        ...
        "Hub South Pool Dead End Path":       CarQuestRegionData([], None),
        ...
        "Hub Start Lookout":                 CarQuestRegionData([], None),
        ...
        "Hub Colloseum Top":                 CarQuestRegionData([], ["Hub Colloseum Podium", "Hub Colloseum Middle Level"]),
