from Options import Range, Choice, ItemSet, OptionSet, PerGameCommonOptions, OptionGroup
from dataclasses import dataclass

class RegionVersion(Choice):
    """
    Selects what game region your Maimai DX is on
    Omnimix includes all removed songs as well
    """
    option_japan = 0
    option_international = 1
    option_usa = 2
    option_china = 3
    option_omnimix = 4
    default = 0
    display_name = "Region Version"
...
class DifficultyOption(OptionSet):
    ...
    default = ["Basic", "Advanced", "Expert", "Master", "Re-Master"]
    valid_keys = ["Basic", "Advanced", "Expert", "Master", "Re-Master"]
...
@dataclass
class MaiOptions(PerGameCommonOptions):
    region_ver: RegionVersion
