...
from .options import MaiOptions, chuni_option_groups
from .MaiCollections import MaiCollections
from .items import MaiSongItem, MaiFixedItem
from .locations import MaiLocation

class MaiWeb(WebWorld):
    theme = "stone"
    tutorials = [Tutorial(
        "Multiworld Setup Guide",
        "A guide to setting up Maimai DX ap",
        "English",
        "setup_en.md",
        "setup/en",
        ["studkid"]
...
class MaiWorld(World):
    """
    Placeholder
    """
    game = "Maimai DX"
    options_dataclass: ClassVar[Type[PerGameCommonOptions]] = MaiOptions
    options: MaiOptions
