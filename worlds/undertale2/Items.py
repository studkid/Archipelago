...
item_table: Dict[str, UT2ItemData] = {
    ...
    "50 DOLLARS":                           UT2ItemData("filler", 1033, ItemClassification.filler, 0, 3),
    ...
    "Monster Zero Ultra White":             UT2ItemData("filler", 1040, ItemClassification.filler, 0, 2),
    ...
    "Shyren's Soup":                        UT2ItemData("filler", 1046, ItemClassification.filler),
    "Pet":                                  UT2ItemData("pgfiller", 1047, ItemClassification.filler, 0, 3),
    "Rare Pet":                             UT2ItemData("pgfiller", 1048, ItemClassification.filler, 0, 1),
    "New Years Eve Bomb":                   UT2ItemData("filler", 1049, ItemClassification.filler, 0, 1),
    "Shakashuri":                           UT2ItemData("filler", 1050, ItemClassification.filler),
